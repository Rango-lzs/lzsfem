...
namespace fem
{
	...
	void Element::computeVectorOf(ValueModeType u, TimeStep* tStep, FloatArray& answer)
	{
		IntArray dofIDMask;
		FloatMatrix G2L;
		FloatArray vec;
	...
	void Element::computeVectorOf(const IntArray& dofIDMask, ValueModeType u, TimeStep* tStep, FloatArray& answer, bool padding)
	{
		FloatMatrix G2L;
		FloatArray vec;
