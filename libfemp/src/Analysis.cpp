...
typename Analysis<Scalar>::Error Analysis<Scalar>::buildEquation(
    Model& model,
...
template <typename Scalar>
typename Analysis<Scalar>::Error Analysis<Scalar>::generateGlobalStiffnessMatrix(
    Model& model,
    AnalysisResult& result,
    ProgressIndicatorStrategy& progress) {
...
template <typename Scalar>
typename Analysis<Scalar>::Error Analysis<Scalar>::generateGlobalDomainForceVector(
    Model& model,
    const LoadPattern& lp,
    AnalysisResult& result,
    ProgressIndicatorStrategy& progress) {
...
template <typename Scalar>
typename Analysis<Scalar>::Error Analysis<Scalar>::generateGlobalSurfaceForceVector(
    Model& model,
    const LoadPattern& lp,
    AnalysisResult& result,
    ProgressIndicatorStrategy& progress) {
...
template <typename Scalar>
typename Analysis<Scalar>::Error Analysis<Scalar>::generateGlobalPointForceVector(
    Model&,
    const LoadPattern& lp,
    AnalysisResult& result,
    ProgressIndicatorStrategy& progress) {
...
template <typename Scalar>
typename Analysis<Scalar>::Error Analysis<Scalar>::recoverValues(
    Model& model,
    AnalysisResult& result) {
...
template <typename Scalar>
typename Analysis<Scalar>::Error Analysis<Scalar>::calculateStrainEnergy(
    Model&,
    AnalysisResult& result) {
