...
public:
    ...
    // Face and Edge Operations (6-node triangular faces)
    virtual void getFaceNodeIds(int faceId, std::array<int, 6>& faceNodes) const;
...
private:
    // Gauss point data (4 points for quadratic tet)
