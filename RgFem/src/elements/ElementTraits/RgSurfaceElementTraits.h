...
public:
    ...
    virtual void project_to_nodes(double* ai, double* ao) const override {}
...
//! class implementing 8-node quad quadrilateral with 9 integration points
//
class Rg2DQuad8G9 : public Rg2DQuad8_
{
public:
	enum { NINT = 9 };
...
//! Base class for 9-node quadratic quadrilaterals
//
class Rg2DQuad9_ : public Rg2DElementTraits
{
public:
	enum { NELN = 9 };

public:
	Rg2DQuad9_(int ni, ElementType et) : Rg2DElementTraits(ni, NELN, ET_QUAD9, et) {}
...
//! class implementing 9-node quad quadrilateral with 9 integration points
//
class Rg2DQuad9G9 : public Rg2DQuad9_
{
public:
	enum { NINT = 9 };
...
//=============================================================================
class RgLineElementTraits : public RgElementTraits
{
public:
...
class RgLine2_ : public RgLineElementTraits
{
public:
	enum { NELN = 2 };
...
public:
	//! constructor
	RgLine2_(int ni, ElementType et) : RgLineElementTraits(ni, NELN, ET_LINE2, et){}
...
//=============================================================================
class RgLine2G1 : public RgLine2_
{
public:
	enum { NINT = 1 };
