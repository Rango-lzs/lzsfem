...
std::vector<double> FEPyra13::evalH(const NaturalCoord& coord)
{
	const NaturalCoord3d* coord3d = dynamic_cast<const NaturalCoord3d*>(&coord);
	if (!coord3d) {
		throw std::invalid_argument("FEPyra13 requires NaturalCoord3d coordinates");
	}
...
std::vector<std::vector<double>> FEPyra13::evalDeriv(const NaturalCoord& coord)
{
	const NaturalCoord3d* coord3d = dynamic_cast<const NaturalCoord3d*>(&coord);
	if (!coord3d) {
		throw std::invalid_argument("FEPyra13 requires NaturalCoord3d coordinates");
...
std::vector<std::vector<double>> FEPyra13::evalDeriv2(const NaturalCoord& coord)
{
	const NaturalCoord3d* coord3d = dynamic_cast<const NaturalCoord3d*>(&coord);
	if (!coord3d) {
		throw std::invalid_argument("FEPyra13 requires NaturalCoord3d coordinates");
	...
	Hst[ 0] = 0.125*r*r - 0.25*s + r*(-0.125 + 0.25*s + 0.25*t) - 0.25*t;
