...
namespace fem
{
	...
	public:
		 ...
		 * @param answer y.
		 */
		virtual void times(const FloatArray& x, FloatArray& answer) const { FEM_ERROR("Not implemented"); }
		/**
		 * Evaluates @f$ y = A^{\mathrm{T}} \cdot x @f$
		 * @param x Array to be multiplied with transpose of the receiver.
		 * @param answer y.
		 */
		virtual void timesT(const FloatArray& x, FloatArray& answer) const { FEM_ERROR("Not implemented"); }
		/**
		 * Evaluates @f$ C = A^{\mathrm{T}} \cdot B @f$
		 * @param B Array to be multiplied with receiver.
		 * @param answer C.
		 */
		virtual void times(const FloatMatrix& B, FloatMatrix& answer) const { FEM_ERROR("Not implemented"); }
		/**
		 * Evaluates @f$ C = A^{\mathrm{T}} \cdot B @f$
		 * @param B Matrix to be multiplied with receiver.
		 * @param answer C.
		 */
		virtual void timesT(const FloatMatrix& B, FloatMatrix& answer) const { FEM_ERROR("Not implemented"); }
		/**
		 * Multiplies receiver by scalar value.
		 * @param x Value to multiply receiver.
		 */
		virtual void times(double x) { FEM_ERROR("Not implemented"); }
		/**
		 * Adds x * m.
		 * @param x Value to multiply m by.
		 * @param m Matrix to add (should of the same matrix type).
		 */
		virtual void add(double x, SparseMtrx& m) { FEM_ERROR("Not implemented"); }
		/**
		 ...
		 */
		virtual int buildInternalStructure(EngngModel* eModel, int n, int m, const IntArray& I, const IntArray& J) { FEM_ERROR("Not implemented"); }
		/**
		...
		{
			FEM_ERROR("Not implemented"); return nullptr;
		}
		...
		virtual void toFloatMatrix(FloatMatrix& answer) const { FEM_ERROR("Not implemented"); }
